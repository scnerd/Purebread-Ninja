...
public class Player extends Character
{
    @Animates(IDLE)
    @DefaultAnimation
    public Sprite idle = ImageSheet("images/BreadNinjaIdle.png", 8);
    
    @Animates(IDLE_CEILING)
    public Sprite hanging = ImageSheet("images/BreadNinjaCeilingStop.png", 1);
    
    @Animates(MOVING_FLOOR)
    public Sprite running = ImageSheet("images/BreadNinjaRun.png", 6);
    
    @Animates(MOVING_AIR)
    public Sprite jumping = ImageSheet("images/BreadNinjaInAir.png", 6);
    
    @Animates(MOVING_WALL)
    public Sprite flying = ImageSheet("images/BreadNinjaWallSlide.png", 2);
    
    @Animates(MOVING_CEILING)
    public Sprite climbing = ImageSheet("images/BreadNinjaCeilingRun.png", 6);
    
    @Animates(HURT)
    public Sprite hurt = Sprite.ImageSheet("images/BreadNinjaHurt1.png", 4);

    @Animates(INVULNERABLE)
    public Sprite invulnerable = Sprite.ImageSheet("images/BreadNinjaHurt2.png", 1);
